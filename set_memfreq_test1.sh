...
do
	...
	x=${MIF_FREQ[$rand]}
	sleep 0.5
	echo $x > /sys/devices/platform/exynos5-busfreq-mif/devfreq/exynos5-busfreq-mif/max_freq
	echo $x > /sys/devices/platform/exynos5-busfreq-mif/devfreq/exynos5-busfreq-mif/min_freq
done
